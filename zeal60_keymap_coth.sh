...
ZEAL_BINARY='../zeal60/zeal60'

$ZEAL_BINARY backlight_config_set_values \
...
caps_lock_indicator_row_col=3,0 \
layer_1_indicator_color=60,100,50 \
layer_1_indicator_row_col=all \
layer_2_indicator_color=20,100,50 \
layer_2_indicator_row_col=all \
layer_3_indicator_color=0,0,100 \
layer_3_indicator_row_col=none

$ZEAL_BINARY backlight_config_set_alphas_mods \
...
KC_LALT  KC_LCTL  KC_LGUI  KC_NO    KC_NO    KC_NO    KC_NO    KC_SPC   KC_NO    KC_NO    FN_MO13  KC_RALT  KC_RCTL  FN_MO23 

$ZEAL_BINARY keymap 1 \
KC_PWR   KC_F1    KC_F2    KC_F3    KC_F4    KC_F5    KC_F6    KC_F7    KC_F8    KC_F9    KC_F10   KC_F11   KC_F12   KC_INS  \
KC_TRNS  KC_MPLY  KC_VOLU  KC_MUTE  KC_TRNS  KC_TRNS  KC_TRNS  KC_TRNS  KC_SLCK  KC_PSCR  KC_UP    KC_HOME  KC_PGDN  KC_DEL \
